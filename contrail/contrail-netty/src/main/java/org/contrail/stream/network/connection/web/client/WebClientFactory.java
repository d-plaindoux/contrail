...
package org.contrail.stream.network.connection.web.client;

import java.net.URI;

import org.contrail.stream.network.connection.nio.NIOClient;
import org.contrail.stream.network.connection.web.handler.WebClientSocketHandler;
import org.contrail.stream.network.connection.web.handler.WebClientSocketHandlerImpl;
