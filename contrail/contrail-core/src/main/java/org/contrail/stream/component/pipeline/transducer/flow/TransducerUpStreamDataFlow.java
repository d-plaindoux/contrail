 ...
 * @version 1.0
 */
public class TransducerUpStreamDataFlow<U, D> implements DataFlow<U> {
	 ...
	 */
	public TransducerUpStreamDataFlow(TransducerComponent<U, ?, D, ?> component, DataTransducer<U, D> downstreamXducer) {
