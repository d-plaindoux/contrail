...
/**
 * <code>DownStreamDataFlowFactory</code> is capable to build data sender.
 * 
 * @author Didier Plaindoux
 * @version 1.0
 */
public interface DownStreamDataFlowFactory<U, D> {
	 ...
	 */
	DownStreamDataFlow<D> create(UpStreamDataFlow<U> component) throws CannotCreateDataFlowException;
