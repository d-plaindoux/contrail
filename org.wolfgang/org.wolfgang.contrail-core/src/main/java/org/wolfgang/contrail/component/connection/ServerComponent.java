...
public class ServerComponent extends AbstractComponent {
	 ...
	 */
	public ServerComponent(ContextFactory contextFactory, String reference, ComponentFactoryListener listener) throws URISyntaxException, ServerNotFoundException, CannotCreateServerException {
