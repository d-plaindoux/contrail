...
import org.wolfgang.contrail.codec.jaxb.xml.Decoder;
import org.wolfgang.contrail.codec.jaxb.xml.Encoder;
 ...
 * @version 1.0
 */
public final class XmlJaxbTransducerFactory implements TransducerFactory<Bytes, Object> {
	...
	public XmlJaxbTransducerFactory(String... types) throws ClassNotFoundException {
	 ...
	 * Constructor
	 */
	public XmlJaxbTransducerFactory(Class<?>... types) {
		this.types = types;
	}
