 ...
 * @version 1.0
 */
public interface DataTransducer<S, D> {
	 ...
	 * @throws DataTransducerException
	 *             thrown if the transformation fails
	 */
	List<D> transform(S source) throws DataTransducerException;
	 ...
	 * @throws DataTransducerException
	 */
	List<D> finish() throws DataTransducerException;
}
