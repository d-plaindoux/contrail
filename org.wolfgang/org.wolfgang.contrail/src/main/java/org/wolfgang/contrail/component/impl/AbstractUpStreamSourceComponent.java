...
public abstract class AbstractUpStreamSourceComponent<E> implements UpStreamSourceComponent<E> {
	...
	@Override
	public void connect(UpStreamDestinationComponent<E> handler) throws ComponentAlreadyConnected {
		if (this.upStreamDestinationComponent == null) {
	...
	@Override
	public void disconnect(UpStreamDestinationComponent<E> handler) throws ComponentNotYetConnected {
		if (this.upStreamDestinationComponent != null) {
