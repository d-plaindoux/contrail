/*
SourceComponent<U, DataWithInformation<D>> * Copyright (C)2012 D. Plaindoux.
 *
...
/**
 * A <code>FilteringSourceComponent</code> is an upstream
 ...
 * @version 1.0
 */
public interface FilteringSourceComponent<U, D> extends SourceComponent<U, DataWithInformation<D>> {
