...
package org.wolfgang.contrail.connector.impl;
...
import org.wolfgang.contrail.connector.ComponentInterconnection;
...
/**
 * <code>ComponentInterconnectionImpl</code> is the main implementation of the
 * component interconnection
 * 
 * @author Didier Plaindoux
 * @version 1.0
 */
public class ComponentInterconnectionImpl<E> implements ComponentInterconnection<E> {
	 ...
	 * @throws ComponentAlreadyConnected thrown if components are already
	 *             connected
	 */
	public ComponentInterconnectionImpl(UpStreamSourceComponent<E> source, UpStreamDestinationComponent<E> destination)
	...
	@Override
	public List<EnvironmentId> getCommunicationIds() {
		return null;
	}
