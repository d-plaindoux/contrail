...
class WebServerHandler extends SimpleChannelUpstreamHandler {
	private static final InternalLogger logger = InternalLoggerFactory.getInstance(WebServerHandler.class);
	...
	public WebServerHandler() {
		this.httpRequestHandler = new HTTPRequestHandler(new WebServerPage());
	}
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception {
		...
		if (msg instanceof HttpRequest) {
			...
			this.sendHttpResponse(ctx, httpRequest, httpRequestHandler.handleHttpRequest(httpRequest));
