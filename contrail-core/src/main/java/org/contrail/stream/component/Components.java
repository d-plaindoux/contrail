...
import org.contrail.stream.component.compose.CompositionComponent;
import org.contrail.stream.component.compose.CompositionDestinationComponent;
import org.contrail.stream.component.compose.CompositionPipelineComponent;
import org.contrail.stream.component.compose.CompositionSourceComponent;
...
public final class Components {
	...
	public static Component compose(Component... components) throws ComponentConnectionRejectedException {
		if (components.length == 0) {
			...
			throw new ComponentConnectionRejectedException(MessagesProvider.from(Components.class).get("org/contrail/stream/message", "not.a.source.and.destination").format());
		}
	}
}
