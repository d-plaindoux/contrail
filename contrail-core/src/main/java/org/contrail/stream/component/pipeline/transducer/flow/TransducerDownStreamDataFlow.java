...
package org.contrail.stream.component.pipeline.transducer.flow;
 ...
 * @version 1.0
 */
public class TransducerDownStreamDataFlow<U, D> implements DataFlow<U> {
	 ...
	 */
	public TransducerDownStreamDataFlow(TransducerComponent<?, D, ?, U> component, DataTransducer<U, D> downstreamXducer) {
